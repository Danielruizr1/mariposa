...
<html ng-app="seguimientos" lang="en" class="dj_webkit dj_chrome dj_contentbox"><head>
    ...
    <!-- Override de estilos del grid para vinculaciones, este override se hace de la clase Claro de Dojo -->
     ...
     <div class="segTable" ng-show="visible && filtered.length">
          ...
          <tr ng-repeat="seguimiento in filtered"  data-id="{{seguimiento.id}}" class="segRow">
             ...
             <div class="row">
                <div class="col-sm-4">
                   <div class="form-group">
                       ...
                       <input  ng-change="changeSearch(find.nombrequienllama, 'nombrequienllama')" ng-model="find.nombrequienllama" class="form-control check check2 nombre requiredd" data-nombre="Contacto:"  name="data[Seguimiento][nombre]" id="nombrequienllama" trim="true">
                   </div>
                </div>
                <div class="col-sm-4">
                   <div class="form-group">
                ...
                <div class="col-sm-4">
                   <div class="form-group">
                        ...
                        <input  ng-change="changeSearch(find.telefono1, 'telefono1')" ng-model="find.telefono1" class="form-control check requiredd" data-nombre="Telefono Fijo 1:" name="data[Seguimiento][telefono1]"  id="telefono1">
                   </div>
                </div>               
             </div>
             <div class="row">
                <div class="col-sm-4">
                   <div class="form-group">
                       ...
                       <input  ng-change="changeSearch(find.telefono2, 'telefono2')" ng-model="find.telefono2" class="form-control check" data-nombre="Telefono Fijo 2:" name="data[Seguimiento][telefono2]" id="telefono2">
                   </div>
                </div>
                <div class="col-sm-4">
                   <div class="form-group">
                       <label for="telefono3" id="titulo">Teléfono Fijo 3:</label><br/>
                       <input  ng-change="changeSearch(find.telefono3, 'telefono3')" ng-model="find.telefono3" class="form-control check" data-nombre="Telefono Fijo 3:" name="data[Seguimiento][telefono3]" id="telefono3">
                   </div>
                </div>
                <div class="col-sm-4">
                   <div class="form-group">
                        <label for="celular" id="titulo">Celular:   (<font color="#FF0000">*</font>)</label></br>
                        <input  ng-change="changeSearch(find.celular, 'celular')" ng-model="find.celular" class="form-control check check2 celular requiredd" data-nombre="Celular:" name="data[Seguimiento][celular]" id="celular">
                   </div>
                </div>               
             </div>
             <div class="row">
          ...
          <div class="row">
               <div class="col-sm-4">
                   <div class="form-group">
                        ...
                        <input  ng-change="changeSearch(find.nombrequinceanera, 'nombrequinceanera')" ng-model="find.nombrequinceanera" class="form-control check nombre14 requiredd" data-nombre="Nombre Quinceañera:" id="nombrequinceanera">
                   </div>
                </div>
                <div class="col-sm-4">
                   <div class="form-group">
