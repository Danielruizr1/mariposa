...
<head>
    ...
    <!-- build:js js/final/vendor.js -->
       <script charset="utf-8" src="../js/seguimientos.js"></script>
    <!-- endbuild -->
   ...
   <div style="float:right; width:79%; height:100%;"><!---Div lado Derecho--->
    <div style="width:100%; height:45px;">
     ...
     <div style="float:left; width:50%;margin-top:-25; text-align:left">
      <h3 style="font-family:Verdana, Geneva, sans-serif; font-size:26px; color:#444444"><img src="/v15/mariposa/img/seguimientos.png" width="22px"/>&nbsp;Gestión de Seguimientos</h3>
     </div>
     <div style="float:right; width:49%;height:45px;text-align:right">
      <div style="width: 190px; height:45px; text-align:right; float:right;">
       <div style="float:left; padding-left:10px;">
         <a href="javascript:window.parent.crearseguimiento('Crear')" style="font-family:Verdana, Geneva, sans-serif; color:#000; text-decoration:none;font-size:12px"><img src="imgs/nuevo.png" border="0"><span style="margin-top:-1em;">Crear</span></a>
       </div>
       <div style="float:left; padding-left:10px">
         <a href="buscar_Seguimiento.php" style="font-family:Verdana, Geneva, sans-serif; color:#000; text-decoration:none; font-size:12px"><img src="imgs/buscar.png" border="0"><span style="margin-top:-1em;">Buscar</span></a>
       </div>
      </div>
     </div>
    </div>
    <div style="width:100%; border:solid 1px #CCCCCC; height:92%;-moz-border-radius: 10px;border-radius: 10px;" id="gridderecho"><!-----Div contenedor de las busquedas y el grid--------->
     ...
     <td align="left"><input type="text" name="nombrenina" id="nombrenina" onKeyUp="filtragrid();"  value="" style="width:180px;-moz-border-radius: 5px;border-radius: 5px; border: #D7D7D7 solid 1px; font-size:18px;"/></td>
     ...
     <div style="float:left; text-align:left; margin-right:4em; font-family:Verdana, Geneva, sans-serif; font-size:14px; margin-top:1em; color:#888888; width:40%">
       <label for="time" id="titulo">Estado:</label>
       <select name="estado" id="estado" onChange="filtraestado();" style="width:220px">
