...
<html lang="en" class="dj_webkit dj_chrome dj_contentbox">
  <head>
    ...
    <!-- build:js js/final/vendor.js -->
      <script src="../js/buscar_inscripcion.js" charset="utf-8"></script>
    <!-- endbuild -->
    <script>   
      ...
      <div style="width:95%;; border:solid 1px #EAEAEA;-moz-border-radius: 15px;border-radius: 15px; height:100%">
       ...
       <div data-dojo-type="dijit.form.Form" id="myForm" data-dojo-id="myForm" encType="multipart/form-data" action="" method="">
        ...
        <div id="fila1" style="width:95%; font-family:Verdana, Geneva, sans-serif; font-size:14px; margin-bottom:5px; margin-left:1em; float:left;">
         ...
         <option value="3">3 Cambio de fecha de viaje</option>
         <option value="4">4 Cambio de fecha de viaje con cambio de destino</option>
         <option value="5">5 Cancelación de viaje</option>
       </select>
          </div>
           <div style="float:left;padding-left:0.5em; text-align:left">
        ...
        <div style="float:left;padding-left:0.5em;text-align:left">
            <label for="time" id="titulo">Asesor:</label><br/>
        ...
        <div id="fila2" style="width:95%; font-family:Verdana, Geneva, sans-serif; font-size:14px; margin-bottom:5px; margin-left:1em; float:left;">
            <div style="float:left;padding-left:0.5em; text-align:left">
          <label for="time" id="titulo" style="text-align:left">Destino:</label><br/>
        ...
        <div style="float:left;padding-left:0.5em;text-align:left">
            <label for="time" id="titulo">Documento Recibido:</label><br/>
            <input  id="interes" class="claro" style="width:220px"/>
           </div>
           <div style="float:left;padding-left:0.5em;text-align:left">
            <label for="time" id="titulo">Visa:</label><br/>
            <input  id="fase" class="claro" style="width:220px"/>
           </div>
           <div style="float:left;padding-left:0.5em;text-align:left">
            <label for="time" id="titulo">Pagos:</label><br/>
            <input  id="pagos" class="claro" style="width:220px"/>
           </div>
...
<div class="dropdown" id="adminDrop">
  ...
  <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
    <li role="presentation"><a role="menuitem" tabindex="-1" onclick="enviarCorreo('sendUserDocs')" >Documentos a usuarios</a></li>
    <li role="presentation"><a role="menuitem" tabindex="-1" onclick="enviarCorreo('sendUserPagos')" >Pagos a usuarios</a></li>
    <li role="presentation"><a role="menuitem" tabindex="-1" onclick="enviarCorreo('sendAdminDocs')">A Administrador</a></li>
  </ul>
</div>
