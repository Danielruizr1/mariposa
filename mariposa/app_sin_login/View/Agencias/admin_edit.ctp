...
<?php echo $this->Form->create('Agencia');?>
	<fieldset>
		<legend><?php echo __('Admin Edit Agencia'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Agencia.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Agencia.id'))); ?></li>
