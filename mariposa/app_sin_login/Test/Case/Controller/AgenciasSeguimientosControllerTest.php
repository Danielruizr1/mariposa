 ...
 * @var array
 */
	public $fixtures = array('app.agencias_seguimiento', 'app.agencia', 'app.departamentos', 'app.ciudades', 'app.seguimiento', 'app.usuarios', 'app.destino', 'app.destinos_seguimiento', 'app.medio', 'app.medios_seguimiento');
