 ...
 * @var array
 */
	public $fixtures = array('app.destinos_seguimiento', 'app.destino', 'app.seguimiento', 'app.usuarios', 'app.departamentos', 'app.ciudades', 'app.agencia', 'app.agencias_seguimiento', 'app.medio', 'app.medios_seguimiento');
