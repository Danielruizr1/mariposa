 ...
 * @var array
 */
	public $fixtures = array('app.medio', 'app.seguimiento', 'app.usuarios', 'app.departamentos', 'app.ciudades', 'app.agencia', 'app.agencias_seguimiento', 'app.destino', 'app.destinos_seguimiento', 'app.medios_seguimiento');
