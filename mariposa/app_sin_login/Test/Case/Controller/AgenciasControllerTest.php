 ...
 * @var array
 */
	public $fixtures = array('app.agencia', 'app.departamentos', 'app.ciudades', 'app.seguimiento', 'app.usuarios', 'app.agencias_seguimiento', 'app.destino', 'app.destinos_seguimiento', 'app.medio', 'app.medios_seguimiento');
