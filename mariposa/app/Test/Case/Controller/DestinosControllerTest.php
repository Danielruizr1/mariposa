 ...
 * @var array
 */
	public $fixtures = array('app.destino', 'app.seguimiento', 'app.users', 'app.departamentos', 'app.ciudades', 'app.agencia', 'app.agencias_seguimiento', 'app.destinos_seguimiento', 'app.medio', 'app.medios_seguimiento');
