        ...
        <center>
		 <div id="header">	
           ...
           <div style="float:right; width:49%;height:70px; margin-top:-15px; margin-right:-200px;">
             <div style="width:100%; text-align:right; padding-top:2em; margin-left:-4.5em;"><h3 style="font-family:Verdana, Geneva, sans-serif; color:#fff; font-size:19px;"><?php echo __('Mariposa 3.11.1'); ?></h3>
             </div>
