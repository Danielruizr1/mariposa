<div class="seguimientos index">
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($seguimiento['Users']['id'], array('controller' => 'users', 'action' => 'view', $seguimiento['Users']['id'])); ?>
		</td>
		<td>
		...
		<td><?php echo h($seguimiento['Seguimiento']['nombre']); ?>&nbsp;</td>
		<td><?php echo h($seguimiento['Seguimiento']['parentesco']); ?>&nbsp;</td>
