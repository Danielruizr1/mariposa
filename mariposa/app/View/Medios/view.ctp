...
<h2><?php  echo __('Medio');?></h2>
	<dl>
		...
		<dd>
			<?php echo h($medio['Medio']['fechaingreso']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Activo'); ?></dt>
		<dd>
			<?php echo h($medio['Medio']['activo']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Medio'), array('action' => 'edit', $medio['Medio']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Medio'), array('action' => 'delete', $medio['Medio']['id']), null, __('Are you sure you want to delete # %s?', $medio['Medio']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Medios'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Medio'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($medio['Seguimiento'])):?>
	...
	<?php
		$i = 0;
		foreach ($medio['Seguimiento'] as $seguimiento): ?>
		<tr>
			<td><?php echo $seguimiento['id'];?></td>
			<td><?php echo $seguimiento['users_id'];?></td>
