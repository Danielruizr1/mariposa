 ...
 * @var array
 */
	public $fixtures = array('app.seguimiento', 'app.usuarios', 'app.departamentos', 'app.ciudades', 'app.agencia', 'app.agencias_seguimiento', 'app.destino', 'app.destinos_seguimiento');
