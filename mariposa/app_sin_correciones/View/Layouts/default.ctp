...
<head>
	...
	?>
   <!---@eduardo:Llamada a los css necesarios para el datagrid---->
   ...
   <!---Fin de la llamada--->  
   <!--@eduardo:Llamada a la libreria de dojo---->
   <script src="http://ajax.googleapis.com/ajax/libs/dojo/1.7.1/dojo/dojo.js" data-dojo-config="async: true, isDebug: true, parseOnLoad: true"></script>
   <!--Fin de la llamada a Dojo---->  
</head>
<body>
	<div id="container">
		<div id="header">
